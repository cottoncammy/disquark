...
class GuildIT {
    ...
    @Test
    void testGetGuildChannels(DiscordBotClient<?> botClient) {

    }

    @Test
    void testCreateGuildChannel(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testGetGuildMember(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testAddGuildMember(DiscordBotClient<?> botClient) {

    }

    @Test
    void testModifyGuildMember(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testAddGuildMemberRole(DiscordBotClient<?> botClient) {

    }

    @Test
    void testRemoveGuildMemberRole(DiscordBotClient<?> botClient) {

    }

    @Test
    void testRemoveGuildMember(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testGetGuildBan(DiscordBotClient<?> botClient) {

    }

    @Test
    void testCreateGuildBan(DiscordBotClient<?> botClient) {

    }

    @Test
    void testRemoveGuildBan(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testGetGuildIntegrations(DiscordBotClient<?> botClient) {
    ...
    @Test
    void testModifyUserVoiceState(DiscordBotClient<?> botClient) {
