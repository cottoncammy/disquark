...
class AuthenticatedDiscordClientIT {
    ...
    @Test
    @Order(2)
    void testCreateGlobalApplicationCommand(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(4)
    void testEditGlobalApplicationCommand(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(5)
    void testBulkOverwriteGlobalApplicationCommands(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(7)
    void testCreateGuildApplicationCommand(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(9)
    void testEditGuildApplicationCommand(DiscordBotClient<?> discordClient) {
        discordClient.editGuildApplicationCommand(applicationId, guildId, guildCommandId)
                .withName("bar")
                .subscribe().withSubscriber(UniAssertSubscriber.create())
                .awaitItem()
                .assertCompleted();
    ...
    @Test
    @Order(10)
    void testBulkOverwriteGuildApplicationCommands(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(13)
    void testDeleteGlobalApplicationCommand(DiscordBotClient<?> discordClient) {
    ...
    @Test
    @Order(14)
    void testDeleteGuildApplicationCommand(DiscordBotClient<?> discordClient) {
